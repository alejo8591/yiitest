...
class Project extends TrackmanActiveRecord
 {
	...
	/**
	 * removes an association between the project, the user and the user's 
	...
	/**
	 * @return boolean wheter or not the current user is in the specified role 
	 * whitin the context of this project
	 */
	 ...
	 * when being added to a tproject
	 */
